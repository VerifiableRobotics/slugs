...
# - the passage in the middle is TWO cells wide
...
# ==================================
#configurations = [(8,2),(16,2),(26,2),(36,2),(4,2),(4,6),(4,12),(4,18),(4,24),(4,30)]
configurations = [(4,2)]
...
def makeBenchmarkFile(configuration):
    ...
    filenamePrefix = "maze_wp_"+str(configuration[0])+"x"+str(configuration[1])

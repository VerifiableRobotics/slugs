...
std::string GR1Context::bddSemanticHash(BF bdd) {
    ...
    boost::random::mersenne_twister_engine< uint64_t, 64, 624, 397, 31, 0x9908b0df, 11, 0xffffffff, 7, 0x9d2c5680, 15, 0xefc60000, 18, 1812433253> randomNumberGenerator(42u);
